...
const DetailScreen = () => {
  ...
  const route = useRouter(); // Utilisez useRoute pour obtenir les paramètres de la route
const house  = route.params; // Accédez aux données de la maison transmises via les paramètres
    ...
    Linking.canOpenURL(phoneURL)
      .then((supported) => {
        if (supported) {
          ...
          console.error(
            "L'ouverture de l'application de téléphone n'est pas prise en charge."
          );
        }
      })
      .catch((error) => {
